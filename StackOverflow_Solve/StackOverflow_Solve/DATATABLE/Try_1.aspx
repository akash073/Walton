...
<body>
    ...
    <asp:GridView ID="GridView1" ClientIDMode="Static" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="IssueID" DataSourceID="SqlDataSource1" class="display nowrap" cellspacing="0" width="100%">
        <Columns>
            <asp:BoundField DataField="IssueID" HeaderText="IssueID" InsertVisible="False" 
                ReadOnly="True" SortExpression="IssueID" />
            <asp:BoundField DataField="IssueName" HeaderText="IssueName" 
                SortExpression="IssueName" />
            <asp:BoundField DataField="IssueDesc" HeaderText="IssueDesc" 
                SortExpression="IssueDesc" />
            <asp:BoundField DataField="IssueType" HeaderText="IssueType" 
                SortExpression="IssueType" />
            <asp:BoundField DataField="IssueCatagory" HeaderText="IssueCatagory" 
                SortExpression="IssueCatagory" />
